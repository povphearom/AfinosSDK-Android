package com.afinos.sdk.auth.util.signincontainer;
...
public abstract class SmartLockBase<R extends Result> extends FragmentBase implements
    ...
    public void onStart() {
        ...
        if (mActivityResultPair != null) {
            ...
            getDialogHolder().showLoadingDialog(com.afinos.sdk.auth.R.string.fui_progress_dialog_loading);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(getContext(),
                com.afinos.sdk.auth.R.string.fui_general_error,
