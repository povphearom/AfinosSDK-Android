...
## Using AfinosSDK to populate a [`RecyclerView`](https://developer.android.com/reference/android/support/v7/widget/RecyclerView.html)

To use the AfinosSDK to display Firebase data, we need a few things:
...
Chat msg = new Chat("puf", "1234", "Hello AfinosSDK world!");
...
But when we build our app using AfinosSDK, we often won't need to register our own EventListener. The
...
## Using AfinosSDK to populate a `ListView`
...
## Using AfinosSDK with indexed data
